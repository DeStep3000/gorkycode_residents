...
2* - Чтобы подсвечивать синтаксис, выбираем интерпретатор для проекта - венв с бэка, папку backend делаем - source. папку frontend - exclude

2** - Нужно самому разобраться, как у тебя в иде добавить node в путь папки frontend, чтобы консоль видела npm оттуда (а мб и не придется это делать)
